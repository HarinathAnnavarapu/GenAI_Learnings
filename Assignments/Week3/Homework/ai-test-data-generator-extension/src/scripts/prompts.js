...
PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY: `
    ...
    export class ComponentPage {
        ...
        constructor(page: Page) {
            this.page = page;
            this.componentTitle = page.locator('h1.title');
        }

        /**
         * Get the component title text
         */
        async getComponentTitle(): Promise<string> {
            return await this.componentTitle.textContent();
        }
    }
    \`\`\`
...
export const CODE_GENERATOR_TYPES = {
  ...
  PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY:'Playwright-Typescript',
